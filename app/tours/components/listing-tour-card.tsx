...
export function ListingTourCard({ tour, viewMode, onClick }: ListingTourCardProps) {
  ...
  return (
    <article
      data-tour-card
      onClick={onClick}
      className="bg-white rounded-[12px] overflow-hidden cursor-pointer group border border-[#E8E8E8] hover:shadow-md transition-shadow"
    >
      ...
      <div className="p-3 pt-3">
        ...
        <div className="flex justify-between items-start gap-2 mb-1.5">
          <div className="flex-1 min-w-0">
            {/* Title */}
            <h3 className="text-[#1C1B1F] font-poppins font-semibold text-[14px] leading-tight mb-1 group-hover:text-[#00A792] transition-colors line-clamp-2">
              {tour.title}
            </h3>
          ...
          <div className="flex flex-col items-end gap-1.5 shrink-0">
            ...
            <div className="flex items-center gap-1">
              <Star className="w-3 h-3 fill-[#FFA432] text-[#FFA432]" />
              <span className="text-[11px] text-[#1C1B1F] font-medium">{tour.rating}</span>
            </div>
