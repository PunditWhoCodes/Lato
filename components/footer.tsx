  ...
  return (
    <footer className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-12">
        {/* Main Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 sm:gap-10 lg:gap-16">
          {/* Left - Brand Section */}
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <Link href="/">
              <Image
                ...
                height={38}
                priority
                className="h-[28px] sm:h-[38px] w-auto"
              />
            </Link>

            {/* Tagline */}
            <p className="font-poppins font-light text-[12px] sm:text-[15px] leading-[18px] sm:leading-[22px] text-black max-w-[200px] sm:max-w-[280px]">
              More than just bookings. Lato connects travelers with curated travel experiences, trusted tour operators.
            </p>

            {/* Social Icons */}
            <div className="flex items-center gap-3 sm:gap-4">
              <SocialIcon href="https://facebook.com/latotravel" aria-label="Facebook">
              ...
              <SocialIcon href="https://instagram.com/latotravel" aria-label="Instagram">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <SocialIcon href="https://x.com/latotravel" aria-label="Twitter">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <SocialIcon href="https://linkedin.com/company/latotravel" aria-label="LinkedIn">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <SocialIcon href="https://youtube.com/@latotravel" aria-label="YouTube">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-8 sm:gap-10">
            {/* Mobile: Row 1 - Travel Experiences, For Traveler's, For Operators (3 columns) */}
            {/* Desktop: Row 1 - 4 columns */}
            <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
              {/* Travel Experiences - First on mobile */}
              <div className="sm:hidden">
                <FooterColumn title="Travel Experiences" isMobile>
                  <FooterLink href="/tours?style=adventure" isMobile>Adventure Tours</FooterLink>
                  <FooterLink href="/tours?style=cultural" isMobile>Cultural & Heritage Trips</FooterLink>
                  <FooterLink href="/tours?style=luxury" isMobile>Luxury Experiences</FooterLink>
                  <FooterLink href="/tours?style=wellness" isMobile>Wellness Retreats</FooterLink>
                  <FooterLink href="/tours?style=family" isMobile>Family Travel</FooterLink>
                </FooterColumn>
              </div>

              {/* For Travelers - Second on mobile */}
              <div className="sm:hidden">
                <FooterColumn title="For Traveler's" isMobile>
                  <FooterLink href="/tours" isMobile>Browse Tours</FooterLink>
                  <FooterLink href="/guides" isMobile>Find Local Guides</FooterLink>
                  <FooterLink href="/support" isMobile>Traveler Support Center</FooterLink>
                  <FooterLink href="/payments" isMobile>Secure Payments</FooterLink>
                  <FooterLink href="/refund-policy" isMobile>Refund Policy</FooterLink>
                </FooterColumn>
              </div>

              {/* For Operators - Third on mobile */}
              <div className="sm:hidden">
                <FooterColumn title="For Operators" isMobile>
                  <FooterLink href="/partner" isMobile>Become a Partner</FooterLink>
                  <FooterLink href="/list-tours" isMobile>List Your Tours</FooterLink>
                  <FooterLink href="/dashboard" isMobile>Operator Dashboard</FooterLink>
                  <FooterLink href="/bookings" isMobile>Manage Bookings</FooterLink>
                  <FooterLink href="/messages" isMobile>Chat with Travelers</FooterLink>
                </FooterColumn>
              </div>

              {/* Desktop layout - Company first */}
            ...
            {/* Mobile: Row 2 - Company, Explore Destinations, Legal (3 columns) */}
            {/* Desktop: Row 2 - 3-4 columns */}
            <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
              {/* Mobile - Company */}
              <div className="sm:hidden">
                <FooterColumn title="Company" isMobile>
                  <FooterLink href="/about" isMobile>About us</FooterLink>
                  <FooterLink href="/blog" isMobile>Blog</FooterLink>
                  <FooterLink href="/testimonial" isMobile>Testimonial</FooterLink>
                  <FooterLink href="/careers" isMobile>Careers</FooterLink>
                </FooterColumn>
              </div>

              {/* Mobile - Explore Destinations */}
              <div className="sm:hidden">
                <FooterColumn title="Explore Destinations" isMobile>
                  <FooterLink href="/tours?region=europe" isMobile>Europe</FooterLink>
                  <FooterLink href="/tours?region=asia" isMobile>Asia</FooterLink>
                  <FooterLink href="/tours?region=middle-east" isMobile>Middle East</FooterLink>
                  <FooterLink href="/tours?region=africa" isMobile>Africa</FooterLink>
                  <FooterLink href="/tours?region=australia" isMobile>Australia</FooterLink>
                </FooterColumn>
              </div>

              {/* Mobile - Legal */}
              <div className="sm:hidden">
                <FooterColumn title="Legal" isMobile>
                  <FooterLink href="/terms" isMobile>Terms of Service</FooterLink>
                  <FooterLink href="/cookies" isMobile>Cookie Settings</FooterLink>
                  <FooterLink href="/privacy" isMobile>Privacy Policy</FooterLink>
                </FooterColumn>
              </div>

              {/* Desktop - Travel Experiences */}
              <div className="hidden sm:block">
            ...
            <div className="sm:hidden flex flex-col gap-2">
              <h4 className="font-poppins font-semibold text-[12px] text-black">
                Contact Us
              </h4>
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  <Phone className="w-[14px] h-[14px] text-[#00A792]" strokeWidth={2.5} />
                  <span className="font-poppins text-[11px] text-[#3A3A3A]">
                    +123 456 7890
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <AtSign className="w-[14px] h-[14px] text-[#00A792]" strokeWidth={2.5} />
                  <span className="font-poppins text-[11px] text-[#3A3A3A]">
                    support@mm.com
                  </span>
                </div>
      ...
      <div className="border-t border-black/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-row items-center justify-center sm:justify-between gap-4 sm:gap-4">
            {/* Copyright */}
            <p className="font-poppins font-light text-[8px] sm:text-[14px] text-[#3A3A3A] whitespace-nowrap">
            ...
            <div className="flex items-center gap-2 sm:gap-5 lg:gap-8">
              <Link
                href="/privacy"
                className="font-poppins font-medium text-[8px] sm:text-[14px] text-[#3A3A3A] hover:text-black transition-colors whitespace-nowrap"
              >
                Privacy Policy
              </Link>
              <Link
              ...
              <Link
                href="/legal"
                className="font-poppins font-medium text-[8px] sm:text-[14px] text-[#3A3A3A] hover:text-black transition-colors"
              >
                Legal
              </Link>
              <Link
...
function FooterColumn({
  ...
  return (
    <div className={`flex flex-col ${isMobile ? 'gap-2' : 'gap-4'}`}>
      <h4 className={`font-poppins font-semibold text-black ${isMobile ? 'text-[10px]' : 'text-[15px]'}`}>
        {title}
      </h4>
      <ul className={`flex flex-col ${isMobile ? 'gap-[6px]' : 'gap-[10px]'}`}>{children}</ul>
    </div>
  )
}
...
function FooterLink({
  ...
  return (
    <li>
      <Link
        href={href}
        className={`font-poppins text-black/80 hover:text-black transition-colors ${isMobile ? 'text-[9px]' : 'text-[14px]'}`}
      >
        {children}
      </Link>
    </li>
