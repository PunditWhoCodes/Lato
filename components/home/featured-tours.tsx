    ...
    <section className="py-[38px] md:py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto pl-[22px] md:px-10">
        ...
        <div className="flex flex-col gap-[17px] lg:gap-[43.35px] mb-6 md:mb-12 lg:mb-16">
          ...
          <div className="flex items-start justify-between">
            ...
            >
              ...
              <div className="relative flex items-center justify-center bg-black rounded-[8.3px] overflow-hidden w-[16.6px] h-[16.6px]">
                <ArrowUpRight className="relative z-10 text-white w-[8.9px] h-[8.9px] transition-transform duration-300 group-hover:rotate-45" />
                <span className="absolute inset-0 bg-[#00A792] rounded-[8.3px] scale-0 opacity-0 transition-all duration-700 ease-out group-hover:scale-150 group-hover:opacity-100 z-0"></span>
              </div>
            </Link>
          </div>
        </div>
        ...
        {displayTours.length === 0 ? (
          ...
          <>
            {/* Mobile: Horizontal Scroll - Figma: cards 218.225px wide, 8px gap */}
